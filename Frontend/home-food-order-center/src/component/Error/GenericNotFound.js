        ...
        return (
            <div className="notFoundDiv">
                ...
                <div className="error">
                    ...
                    <div className="error__subtitle">Хмм...</div>
                    <div className="error__description pb-2">Явно страницата не е намерена</div>
                    <Link to={frontendUtils.CATALOG_PATH} className="error__button error__button--active">Каталог</Link>
                    <Link to={frontendUtils.ABOUT_US} className="error__button">ABOUT US</Link>
                </div>
